...
// ------------------------------------------------------------My implementations
//Allows Fraction - integer
Fraction Fraction::operator-(const int &other) const{
    Fraction fraction = *this;
    fraction.numerator = fraction.numerator-other*fraction.denominator;
    return fraction;
}

//Allows integer - Fraction
Fraction operator-(const int &integer,const Fraction &other){
    Fraction fraction = other;
    fraction.numerator = integer*other.denominator - other.numerator;
    return fraction;
}
